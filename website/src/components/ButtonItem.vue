...
<template>
    <article
        class="flex flex-col w-full h-48 border-2 border-stone-50 rounded-xl bg-stone-50/10 backdrop-blur-lg hover:bg-stone-50/[15%] active:bg-stone-50/5"
    ...
    >
        ...
        <main
            class="grow grid place-items-center pointer-events-none overflow-hidden"
            :innerHTML="innerHTML"
            ref="buttonContainer"
        ></main>
    </article>
